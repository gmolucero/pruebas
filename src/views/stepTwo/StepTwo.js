    ...
    return (
        <CRow className="justify-content-center">
            {loading ? <Spinner /> : <CCol md={8} lg={6}>
                ...
                {(states.independent_income && states.independent_income.length >= 3) ?  <p className="text-left"><strong> Ya tienes 3 rentas, para poder agregar otra renta debes eliminar una </strong></p> :  <p className="text-left"><strong>Cuéntanos de tus ingresos líquidos en los últimos 3 meses </strong></p>}
                {
                    type !== 'dependiente' && <>
