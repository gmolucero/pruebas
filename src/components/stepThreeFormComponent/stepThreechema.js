...
export const stepThreechema = () => {
  return Yup.object().shape({
    ...
    number_quotas: Yup.number()
      .typeError("Deben sen valores númericos")
      .required("el numero de cuotas es requerido")
      .integer("valor no válido")
      .moreThan(3, "Número de cuotas debe ser mayor a 3")
      .max(60, "El número de cuotas no puede ser mayor a 60"),
    ...
    // ),terms_id: Yup.number().moreThan(0, "Debe aceptar los términos y condiciones"),
  });
};
